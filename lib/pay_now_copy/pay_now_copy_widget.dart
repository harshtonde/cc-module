...
class PayNowCopyWidget extends StatefulWidget {
  const PayNowCopyWidget({Key? key}) : super(key: key);

  @override
  _PayNowCopyWidgetState createState() => _PayNowCopyWidgetState();
}

class _PayNowCopyWidgetState extends State<PayNowCopyWidget> {
  ...
  void initState() {
    super.initState();
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'payNowCopy'});
                                                        ...
                                                        children: [
                                                          Text(
                                                            FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                              '4e68ii1n' /* PAY YOUR ICICI BANK CREDIT CAR... */,
                                                            ),
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          Row(
                                                                            ...
                                                                            children: [
                                                                              ...
                                                                              Text(
                                                                                FFLocalizations.of(context).getText(
                                                                                  'jfn8o6ck' /* ICICI Bank MakeMyTrip Platinum */,
                                                                                ),
                                                                                style: FlutterFlowTheme.of(context).bodyText1.override(
                                                                                      fontFamily: FlutterFlowTheme.of(context).bodyText1Family,
                                                                                      color: FlutterFlowTheme.of(context).secondaryText,
                                                  ...
                                                  children: [
                                                    Text(
                                                      FFLocalizations.of(
                                                              context)
                                                          .getText(
                                                        'm5hj66hd' /* How much do you want to pay? */,
                                                      ),
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
