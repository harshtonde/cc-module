...
class EnableAutopaySuccessWidget extends StatefulWidget {
  const EnableAutopaySuccessWidget({Key? key}) : super(key: key);

  @override
  _EnableAutopaySuccessWidgetState createState() =>
      _EnableAutopaySuccessWidgetState();
}

class _EnableAutopaySuccessWidgetState extends State<EnableAutopaySuccessWidget>
